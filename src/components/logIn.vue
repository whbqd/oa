<template>
  <div id="logIn">
    ...
    <div class="background">
      ...
      <div class="logon">
        <!-- 左边部分 -->
        <div class="letfPic" id="letfPic">
          <img src="../assets/leftPic.png" />
        </div>
        <!-- 右边部分 -->
      ...
      <!-- 左下角 -->
      <img src="../assets/zuoxia.png" class="zuoxia" id="zuoxia" />
      <!-- 右上角 -->
      <img src="../assets/youshang.png" class="youshang" id="youshang" />
    </div>
  </div>
</template>
